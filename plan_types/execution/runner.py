...
would an adapter living in another package that has never heard of `plan_types` — which is the
...
Two of the four handoffs that produced this module disagreed: one argued PlanTypes must stay
