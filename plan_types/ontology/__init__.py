"""PROV-O types: what actually happened, as opposed to what was planned.
    ...
    p-plan:Step      the intended operation        plan_types.plan.Step
...
referential integrity. Wiring it to `plan_types.execution.run` would make a run produce a provenance
document; that is not built.
"""
from plan_types.ontology.prov import (Activity, Agent, Entity, GraphError, Node, Run, Used,
