...
class Step(DeclaredTerm, Generic[InputT, OutputT]):
    ...
    performed, and a `StepRunner` performs it — `workflow_plan.execution`. A Step you cannot execute
    ...
    _RETIRED_WHY: ClassVar[dict[str, str]] = {
        ...
        "run":
            ...
            "Strategy instead — `from workflow_plan.execution import LocalRunner, run` — which "
