...
class Plan(DeclaredTerm):
    ...
    order is derived from the bindings — see `workflow_plan.plan.bindings.execution_order`.
    """
...
class MultiStep(Plan, PlanStep):
    ...
    def iterative(self) -> bool:
        ...
        from workflow_plan.plan.bindings import execution_order  # noqa: PLC0415 — import cycle
